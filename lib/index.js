...
module.exports = options => {
    ...
    let maxSize = options.size || 1e4;
    let maxAge = options.age || 86400; // 1 day
    ...
    if(!_.isFinite(maxAge)) {
        throw new Error('#age must be undefined, or a Number');
    }
